...
git_sparse_clone main https://github.com/kiddin9/op-packages luci-app-msd_lite msd_lite
...
git_sparse_clone main https://github.com/kiddin9/op-packages luci-app-ddns-go ddns-go
